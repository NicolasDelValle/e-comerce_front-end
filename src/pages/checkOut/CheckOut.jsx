								...
								<div>
									<div className="d-flex flex-column">
										<div className="d-flex flex-column justify-content-start mb-2">
											<span className="me-auto fw-bold mb-1 ">Numero De Tarjeta</span>
											<input
												onInput={(e) => {
										...
										<div className="d-flex flex-row">
											<div className="d-flex flex-column justify-content-start mb-2 me-2">
												<span className="me-auto fw-bold mb-1">Vencimiento</span>
												<input
													onInput={(e) => {
											...
											<div className="d-flex flex-column justify-content-start mb-2">
												<span className="me-auto fw-bold mb-1">Codigo de Seguridad</span>
												<input
													onInput={(e) => {
									...
									<div className="d-flex flex-column justify-content-start mb-2">
										<span className="me-auto fw-bold mb-1">Nombre en Tarjeta</span>
										<input
											onInput={(e) => {
									...
									<div className="d-flex flex-column justify-content-start mb-3 w-100 overflow-hidden">
										...
										>
											...
											{address?.map(({ address, number, state, city, postalCode }) => (
												<option
					...
					<Col md={12} lg={7}>
						<div className="border p-3 mb-3">
							...
							<div className="d-flex align-items-start py-1 my-2 border-top">
								...
								<span className="fs-5 fw-bold ms-auto me-1">${total.toFixed(2)}</span>
							</div>
							<div></div>
						</div>
					</Col>
