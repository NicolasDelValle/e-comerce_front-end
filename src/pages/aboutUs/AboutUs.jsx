	...
	return (
		<>
			...
			<div>
				...
				<div className="row">
					<div className="col-11 col-md-7 mx-auto my-5 about-text">
						<p>
							...
							dedicación <b>full-time</b>, con una duración de <b>tres meses</b> y
							clases de Lunes a Viernes de 9 a 18hs.
						</p>
						<p>
						...
						<p className="m-0">
							...
							con <b>tres semanas para su desarrollo,</b> por lo que la comunicación,
							el orden y el trabajo en equipo fueron factores fundamentales.
						</p>
					</div>
					<hr className="col-7 mx-auto" />
					<h2>Desarrolladores</h2>
					<div className="col-11 col-md-7 mx-auto d-flex flex-wrap justify-content-between">
