      ...
      <div className="container">
        <div className="row mt-5 d-flex  justify-content-center">
          ...
          <div className="col-md-8 mx-auto mt-3 about-text">
            <p>
              La creación de este sitio web se dio en el marco del proyecto
              final del{" "}
              <a
              ...
              dedicación full-time, con una duración de tres meses y clases de
              Lunes a Viernes de 9 a 18hs.
            </p>
            <p>
              El proyecto consiste en la creación de un sitio web de e-commerce,
              donde los estudiantes tenemos la posibilidad de utilizar todos los
              conocimientos obtenidos durante la cursada, aplicándolos en la
              creación de una web que cuente con las características y
              funcionalidades que se esperan encontrar en cualquiera de las que
              visitamos a diario para realizar compras o ver productos.
            </p>
            <p>
            ...
            <p>
              ...
              para organizarnos, dividirnos tareas y para llevar al día el
              proceso de desarrollo de nuestro sitio web. Nos reunimos a través
              de{" "}
              <a className="about-text-link" href="http://discord.com">
                Discord,
              </a>{" "}
              plataforma de gran utilidad ya que además de facilitar una
              comunicación rápida y fluida permite realizar presentaciones de
              pantalla, en las que cada integrante del equipo pudo mostrar las
              nuevas implementaciones antes de que fueran incorporadas al
              proyecto. Llevamos a cabo reuniones al empezar, durante y también
              al terminar cada jornada de trabajo, para reasignar tareas y
              apoyarnos en dudas que hayan surgido.
            </p>
            ...
            <div className="d-flex flex-wrap justify-content-between mt-3 mb-5 credentials-div">
              <p>
                Si deseas probar todas las funcionalidades del sitio, estas son
                las credenciales:
              </p>
