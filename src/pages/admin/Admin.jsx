					...
					<div class="row mt-4">
							...
							<Card bg="light" border="info" className="mb-4">
								...
								<Card.Body>
									<ListGroup className="text-start">
										...
										<ListGroup.Item>Tabla Santa Cruz Johnson Beach</ListGroup.Item>
										<ProgressBar now={71} label={71} />
										<ListGroup.Item>Ruedas Kimbel Kegger Barrel Elite</ListGroup.Item>
						...
						<div class="col-xl-3 col-md-6">
							<Card className="mb-4">
								...
								<Card.Body>
									<ListGroup className="text-start">
										<ListGroup.Item>Ruedas Slime Balls Brains Speed Balls</ListGroup.Item>
										<ProgressBar now={23} label={23} variant="warning" />
										<ListGroup.Item>Ruedas Spitfire Formula Four Classic</ListGroup.Item>
