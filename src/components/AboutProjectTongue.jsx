		...
		<>
			<div>
				...
				<div className="tongue-modal">
					...
					<div>
						<Link to="/aboutus" className="tongue-modal-link rounded-pill btn">
							Ver más
						</Link>
					</div>
					<div className="d-flex flex-column">
						<h6 className="m-0 tongue-modal-title mt-5 mb-3">Desarrolladores</h6>
