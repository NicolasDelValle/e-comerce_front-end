      ...
      <div>
        ...
        <label className="tongue-label" htmlFor="input-checkbox">
          <BsFillCaretRightFill
            size={15}
            className="me-1 mb-1 tongue-label-caret"
          />
          <h6 className="m-0 tongue-label-title">Sobre el Proyecto</h6>
        </label>

        <div className="tongue-modal px-3 pt-4">
          <h6 className="tongue-modal-title">Sobre el Proyecto</h6>
          <div className="tongue-modal-text">
            <p>
              Este proyecto fue creado como trabajo final del Coding Bootcamp de
              Hack Academy, en la edición de Enero de 2022.
            </p>
            <p>
              La consigna de este trabajo final consistía en la creación de un
              e-commerce a elección libre, teniendo para su desarrollo un lapso
              de 3 semanas.
            </p>
          </div>

          <div className="d-flex flex-column">
            <h6 className="m-0 tongue-modal-title mt-3 mb-3">
              Desarrolladores
            </h6>
                ...
                <div className="modal-avatar-text mt-1">
                  ...
                  <div className="d-flex justify-content-center align-items-center">
                    <a href="https://www.linkedin.com/in/luis-zunino/">
                      <SiLinkedin
                        size={15}
                        className="mx-1 modal-avatar-icon"
                      />
                    </a>
